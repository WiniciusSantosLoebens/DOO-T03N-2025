package org.fag;
import org.fag.controller.ApiClient;
import org.fag.controller.SeriesMapper;
...
public class Main {
    ...
    public Main(SeriesMapper serieMapper, FavoritesManager favorites, WatchedManager watched, WatchlistManager watchlist) {
    ...
    public static void main(String[] args) {
        ...
        FavoritesManager fav = new FavoritesManager();
        WatchedManager watched = new WatchedManager();
        WatchlistManager later = new WatchlistManager();

        Main app = new Main(mapper, fav, watched, later);
        app.start();
    }
