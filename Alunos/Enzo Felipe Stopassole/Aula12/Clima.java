...
public class Clima {
    ...
    private static final String API_KEY = "9592TB744B7GJWUVA6CYSRQ4D";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (resposta == null || resposta.isEmpty()) {
                System.out.println("Não foi possível obter os dados do clima ou a resposta da API está vazia.");
                return;
            }
    ...
    private static String requisitarHttp(String urlStr) throws Exception {
        ...
        if (codigoResposta != HttpURLConnection.HTTP_OK) {
            System.err.println("Erro na requisição HTTP. Código de resposta: " + codigoResposta);
