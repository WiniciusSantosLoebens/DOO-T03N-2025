...
public class SistemaPrincipal {
    ...
    public static void main(String[] args) {
      ...
      //pega os dados armazenados no arquivo do gerenciador de dados
        ...
        //caso não tenha nome salvo, pede o nome e salva
        if (usuario.getNome() == null || usuario.getNome().isEmpty()) {
        	
            System.out.println("Bem vindo ao Catálogo de séries!");
        ...
        //pede oq quer fazer e exibe o menu
        System.out.println("\nOlá, " + usuario.getNome() + "! O que você gostaria de fazer?");
        ...
        while (opcao != 0) {
            ...
            try {
                ...
                //detecta uma entrada diferente do que o scanner espera. Exibe mensagem de erro e volta o valor de opção para -1
    ...
    //metodo para buscar a serie
    //salva o nome que o usuario escolheu,manda para a classe api o nome para a busca, se for nula oua lista estu=iver vazia, exibe mensagem de erro.
    //se foi encontrada, roda uma lista .size, roda a quantidade de intens que  tem na lista.
    //pede pro usuario escolher s serie entre as que foram encontradas com o nome qu eo usuario digitou, pq a busca é aproximada.
